...
class wxpay_jsapi extends abstract_payment
{
    public $data = null;
    ...
    public function GetOpenid()
    {
        ...
        if (!isset($_GET['code'])){
            ...
            //触发微信返回code码
            $scheme = $_SERVER['REQUEST_SCHEME']=='on' ? 'https://' : 'http://';
     ...
     * @return string
     */
    public function createJsBizPackage($openid, $totalFee, $outTradeNo, $orderName, $notifyUrl, $timestamp,$text='pay')
    {
        $config = array(
