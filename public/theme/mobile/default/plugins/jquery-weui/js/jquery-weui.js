...
function computeInputData(manager, input) {
    ...
    // storeController the first input to calculate the distance and direction
    if (!session.firstInput) {
        session.firstInput = simpleCloneInputData(input);
    }

    // to compute scale and rotation we need to storeController the multiple touches
...
inherit(PointerEventInput, Input, {
    ...
    handler: function PEhandler(ev) {
        ...
        // get index of the event in the storeController
        ...
        // update the event in the storeController
        store[storeIndex] = ev;
        ...
        if (removePointer) {
            // remove from the storeController
...
Manager.prototype = {
    ...
    recognize: function(inputData) {
        ...
        while (i < recognizers.length) {
            ...
            // if the recognizer has been recognizing the input as a valid gesture, we want to storeController this one as the
