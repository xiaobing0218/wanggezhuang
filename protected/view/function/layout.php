...
function layout_usermenu()
{
    ...
    (
        array(
            'name' => '我的账户',
            'list' => array(
                array('name' => '个人中心', 'c' => 'user', 'a' => 'index'),
                array('name' => '个人信息', 'c' => 'user', 'a' => 'profile'),
                array('name' => '地址管理', 'c' => 'consignee', 'a' => 'list'),
            )
        ),
        array(
            'name' => '交易管理',
            'list' => array(
                ...
                array('name' => '商品评价', 'c' => 'review', 'a' => 'list'),
                array('name' => '开票信息管理', 'c' => 'invoice', 'a' => 'index'),
            )
        ),
        array(
            'name' => '我的收藏',
            'list' => array(
                array('name' => '产品收藏', 'c' => 'favorite', 'a' => 'list'),
                array('name' => '店铺收藏', 'c' => 'favorite', 'a' => 'store'),
            )
        ),
        array(
            'name' => '服务中心',
...
//                array('name' => '在线客服', 'c' => 'aftersales', 'a' => 'list'),
                array('name' => '咨询反馈', 'c' => 'feedback', 'a' => 'list'),
                array('name' => '安全设置', 'c' => 'security', 'a' => 'index'),
                array('name' => '商家申请入驻', 'c' => 'enter', 'a' => 'index'),
            )
        )
    );
